...
import { NotificationRecipientType, Prisma, ReviewStatus, UserRole } from '@prisma/client';
...
export class GiftManagementRepository {
  ...
  findGiftCategoryById(id: string) { return this.prisma.giftCategory.findFirst({ where: { id } }); }
