...
describe('Gift management repository cleanup', () => {
  ...
  const repository = readFileSync(join(__dirname, 'gift-management.repository.ts'), 'utf8');
  const categoriesController = readFileSync(join(__dirname, 'gift-categories.controller.ts'), 'utf8');
  const lookupController = readFileSync(join(__dirname, 'gift-categories-lookup.controller.ts'), 'utf8');
  const giftsController = readFileSync(join(__dirname, 'gifts.controller.ts'), 'utf8');
  const moderationController = readFileSync(join(__dirname, 'gift-moderation.controller.ts'), 'utf8');
  const customerMarketplaceService = readFileSync(join(__dirname, '../customer-marketplace/customer-marketplace.service.ts'), 'utf8');
