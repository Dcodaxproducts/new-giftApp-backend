...
export class AdminDisputesController {
  ...
  @ApiOperation({ summary: 'Preview dispute refund selection', description: 'SUPER_ADMIN or ADMIN with disputes.refund.evaluate. Validates requested refunds against payment status, prior refunds, and active refund policy settings without processing a refund.' })
