...
describe('Social moderation repository cleanup', () => {
  const service = readFileSync(join(__dirname, 'social-moderation.service.ts'), 'utf8');
  const moderationRepository = readFileSync(join(__dirname, 'social-moderation.repository.ts'), 'utf8');
  const rulesRepository = readFileSync(join(__dirname, 'social-reporting-rules.repository.ts'), 'utf8');
  const controller = readFileSync(join(__dirname, 'social-moderation.controller.ts'), 'utf8');
