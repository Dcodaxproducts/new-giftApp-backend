...
import { AdminSubmitProviderDocumentDto } from './dto/provider-documents.dto';
...
export class AdminProviderDocumentsController {
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: [{ document: { id: 'doc_id', name: 'Business License', isRequired: true }, submission: { id: 'provider_doc_id', fileUrl: 'provider-documents/license.pdf', status: 'APPROVED', createdAt: '2025-01-01T00:00:00.000Z', updatedAt: '2025-01-01T00:00:00.000Z' } }], message: 'My documents fetched successfully.' } } })
