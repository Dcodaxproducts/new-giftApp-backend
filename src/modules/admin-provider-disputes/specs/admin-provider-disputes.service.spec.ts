...
describe('Admin Provider Dispute Management Core module', () => {
  const service = readFileSync(join(__dirname, '../services/admin-provider-disputes.service.ts'), 'utf8');
  const disputesRepository = readFileSync(join(__dirname, '../repositories/admin-provider-disputes.repository.ts'), 'utf8');
  const evidenceRepository = readFileSync(join(__dirname, '../repositories/provider-dispute-evidence.repository.ts'), 'utf8');
  const rulingsRepository = readFileSync(join(__dirname, '../repositories/provider-dispute-rulings.repository.ts'), 'utf8');
  const financialRepository = readFileSync(join(__dirname, '../repositories/provider-dispute-financial.repository.ts'), 'utf8');
  const resolutionRepository = readFileSync(join(__dirname, '../repositories/provider-dispute-resolution.repository.ts'), 'utf8');
  const logsRepository = readFileSync(join(__dirname, '../repositories/provider-dispute-logs.repository.ts'), 'utf8');
  const controller = readFileSync(join(__dirname, '../controllers/admin-provider-disputes.controller.ts'), 'utf8');
