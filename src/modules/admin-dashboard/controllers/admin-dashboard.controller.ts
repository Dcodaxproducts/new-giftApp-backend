...
export class AdminDashboardController {
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: { totalUsers: 0, totalUsersDeltaPercent: 0, totalProviders: 0, totalProvidersDeltaPercent: 0, orders: 0, ordersDeltaPercent: 0, transactions: 0, transactionsDeltaPercent: 0, totalRevenue: 0, totalRevenueDeltaPercent: 0, currency: 'USD' }, message: 'Dashboard overview fetched successfully.' } } })
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: { range: 'LAST_12_MONTHS', labels: ['Jan', 'Feb', 'Mar'], values: [0, 0, 0], currency: 'USD' }, message: 'Revenue trends fetched successfully.' } } })
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: { giftCardsPercent: 0, directPaymentsPercent: 0 }, message: 'Gift vs payment distribution fetched successfully.' } } })
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: [{ providerId: 'provider_id', providerName: 'Provider', successRate: 0, totalVolume: 0, currency: 'USD' }], message: 'Provider performance fetched successfully.' } } })
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: [], message: 'Recent disputes fetched successfully.' } } })
