...
describe('Customer Transactions module', () => {
  const service = readFileSync(join(__dirname, '../services/customer-transactions.service.ts'), 'utf8');
  const repository = readFileSync(join(__dirname, '../repositories/customer-transactions.repository.ts'), 'utf8');
  const controller = readFileSync(join(__dirname, '../controllers/customer-transactions.controller.ts'), 'utf8');
