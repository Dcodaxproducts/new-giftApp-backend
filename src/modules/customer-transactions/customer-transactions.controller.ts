...
export class CustomerTransactionsController {
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: { totalSpentThisMonth: 255, currency: 'USD', successfulCount: 9, failedCount: 1, pendingCount: 0, refundedCount: 0 }, message: 'Transaction summary fetched successfully.' } } })
  ...
  @ApiResponse({ status: 200, schema: { example: { success: true, data: { id: 'payment_id', transactionId: 'TXN-2026-001234-ABC-XYZ', status: 'SUCCESS', amount: 50, currency: 'USD', createdAt: '2026-03-01T14:34:00.000Z', type: 'RECURRING_PAYMENT', giftInformation: { giftName: 'Monthly Flowers Subscription', deliveryType: 'Money', recipient: { id: 'contact_id', name: 'Sarah Johnson', avatarUrl: 'https://cdn.yourdomain.com/customer-contact-avatars/sarah.png' }, orderReference: null, recurringPaymentId: 'recurring_payment_id' }, paymentInformation: { paymentMethod: 'Stripe card', gatewayReference: 'pi_3MmlLrLkdIwHu7ix0fhBHWqt', billingAddress: null } }, message: 'Transaction details fetched successfully.' } } })
