...
@Module({ imports: [DatabaseModule, UserManagementModule, ProviderManagementModule, BroadcastNotificationsModule, ReportingCoreModule], controllers: [MessageModerationController], providers: [MessageModerationService, MessageModerationScanner, MessageModerationRepository], exports: [MessageModerationService, MessageModerationScanner] })
