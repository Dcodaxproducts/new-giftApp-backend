...
@Module({ imports:[BroadcastNotificationsModule,DatabaseModule,MessageModerationModule], controllers:[SupportChatController], providers:[SupportChatService,SupportChatRepository], exports:[SupportChatService] })
