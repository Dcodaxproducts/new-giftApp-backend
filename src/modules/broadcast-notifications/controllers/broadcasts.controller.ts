...
export class BroadcastsController {
  ...
  @Patch(':id/schedule') @Permissions('broadcasts.schedule') schedule(@CurrentUser() user: AuthUserContext, @Param('id') id: string, @Body() dto: ScheduleBroadcastDto) { return this.broadcasts.schedule(user, id, dto); }
