...
export class AdminTransactionsService {
  ...
  private paymentInclude() { return { user: { select: { id: true, firstName: true, lastName: true, email: true, avatarUrl: true, location: true } }, order: { include: { provider: { select: { id: true, providerProfile: { select: { businessName: true } } } } } }, moneyGift: true, customerSubscription: true, recurringPaymentOccurrences: { include: { recurringPayment: true } }, refundRequests: true } satisfies Prisma.PaymentInclude; }
