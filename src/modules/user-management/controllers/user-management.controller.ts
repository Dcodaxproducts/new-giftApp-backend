...
export class UserManagementController {
  ...
  @ApiResponse({ status: 200, description: 'Users fetched successfully', schema: { example: { success: true, data: [{ id: 'user_id', email: 'customer@example.com', firstName: 'Sarah', lastName: 'Johnson', phone: '+923001234567', role: 'REGISTERED_USER', status: 'APPROVED', createdAt: '2026-05-09T10:00:00.000Z' }], meta: { page: 1, limit: 10, total: 1, totalPages: 1 }, message: 'Users fetched successfully' } } })
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        success: true,
        data: { id: 'user_id', status: 'SUSPENDED', suspension: { reason: 'POLICY_VIOLATION', comment: 'User violated platform policy.', suspendedAt: null, suspendedBy: null } },
