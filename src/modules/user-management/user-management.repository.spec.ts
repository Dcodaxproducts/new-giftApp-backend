...
describe('User management repository cleanup', () => {
  ...
  const service = readFileSync(join(moduleDir, 'user-management.service.ts'), 'utf8');
  const repository = readFileSync(join(moduleDir, 'user-management.repository.ts'), 'utf8');
  const moduleFile = readFileSync(join(moduleDir, 'user-management.module.ts'), 'utf8');
  const controller = readFileSync(join(moduleDir, 'user-management.controller.ts'), 'utf8');
