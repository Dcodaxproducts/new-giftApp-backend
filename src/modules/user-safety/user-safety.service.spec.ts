...
describe('UserSafetyAdminService', () => {
  it('lists reports and performs warn/suspend/dismiss actions with audit and notifications', async () => {
    ...
    await service.action({ uid: 'admin_1', role: UserRole.ADMIN }, report.id, { action: UserSafetyAdminAction.WARN_REPORTED_USER, reason: 'HARASSMENT_CONFIRMED', notifyReporter: true, notifyReportedUser: true });
