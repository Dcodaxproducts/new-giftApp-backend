...
@Module({ imports: [DatabaseModule], controllers: [UserSafetyController, UserSafetyAdminController], providers: [UserSafetyService, UserSafetyAdminService, UserSafetyRepository, UserSafetyAdminRepository, BlockedUsersRepository, AuditLogWriterRepository, AuditLogWriterService], exports: [UserSafetyService] })
