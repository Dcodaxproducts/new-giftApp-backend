...
import { CreateChatThreadDto, ListChatsDto, ListThreadMessagesDto, SendUnifiedChatMessageDto, UpdateChatThreadStatusDto } from './dto/chats.dto';
...
export class ChatsController {
  ...
  @Get()
  @ApiOperation({ summary: 'List unified chat threads', description: 'Role-aware list for customer order chats, provider buyer chats, support chats, and admin-visible support/moderation chat views.' })
  ...
  @Post('threads')
  @ApiOperation({ summary: 'Create or get a unified chat thread' })
  ...
  @ApiOperation({ summary: 'Fetch unified chat thread details' })
  ...
  @ApiOperation({ summary: 'Fetch unified chat thread messages' })
  ...
  @ApiOperation({ summary: 'Send a unified chat message' })
  @ApiBody({ type: SendUnifiedChatMessageDto })
  sendMessage(@CurrentUser() user: AuthUserContext, @Param('threadId') threadId: string, @Body() dto: SendUnifiedChatMessageDto) {
    return this.chats.sendMessage(user, threadId, dto);
  }

  @Patch('threads/:threadId/read')
  @ApiOperation({ summary: 'Mark a unified chat thread as read' })
  ...
  @ApiOperation({ summary: 'Update unified chat thread status' })
  ...
  @ApiOperation({ summary: 'Fetch unified chat thread audit log' })
