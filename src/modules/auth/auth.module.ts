...
@Module({
  ...
  providers: [AuthService, AdminStaffRepository, AdminRolesRepository, PermissionsCatalogRepository, AuthRepository, AuthSessionsRepository, AuthPasswordRepository, PrismaService, JwtAuthGuard],
  exports: [AuthService],
})
