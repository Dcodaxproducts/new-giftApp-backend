...
@Module({ imports: [JwtModule.register({})], controllers: [ProviderEarningsController, ProviderPayoutsController], providers: [ProviderEarningsPayoutsService, ProviderEarningsPayoutsRepository, PrismaService] })
