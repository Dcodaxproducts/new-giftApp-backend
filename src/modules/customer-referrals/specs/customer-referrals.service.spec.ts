...
describe('Customer referrals and rewards source safety', () => {
  const serviceSource = readFileSync(join(__dirname, '../services/customer-referrals.service.ts'), 'utf8');
  const referralsRepositorySource = readFileSync(join(__dirname, '../repositories/customer-referrals.repository.ts'), 'utf8');
