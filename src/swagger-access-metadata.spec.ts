...
describe('Swagger access metadata', () => {
  it.each([
    ...
    ['post', '/api/v1/broadcasts', 'SUPER_ADMIN or ADMIN with broadcast action permission'],
    ['post', '/api/v1/broadcasts/{id}/action', 'SUPER_ADMIN or ADMIN with broadcast action permission'],
