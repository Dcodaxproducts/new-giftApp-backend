...
export const SWAGGER_ACCESS_RULES: Record<string, SwaggerAccessRule> = {
  ...
  'POST /api/v1/admin/message-moderation/messages/{messageId}/block': { allowedRoles: 'SUPER_ADMIN or ADMIN with messageModeration.block', description: 'SUPER_ADMIN or ADMIN with messageModeration.block permission. Creates moderation and audit logs.' },
  ...
  'POST /api/v1/admin/message-moderation/messages/{messageId}/dismiss-flag': { allowedRoles: 'SUPER_ADMIN or ADMIN with messageModeration.dismiss', description: 'SUPER_ADMIN or ADMIN with messageModeration.dismiss permission.' },
  ...
  'POST /api/v1/admin/message-moderation/messages/{messageId}/reprocess': { allowedRoles: 'SUPER_ADMIN or ADMIN with messageModeration.moderate', description: 'SUPER_ADMIN or ADMIN with messageModeration.moderate permission.' },
