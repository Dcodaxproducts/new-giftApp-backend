...
describe('JwtAuthGuard', () => {
  ...
  it('blocks pending providers from selling modules while allowing business info', async () => {
    ...
    await expect(guard.canActivate(contextWithHeader('Bearer token', '/api/v1/chats'))).rejects.toThrow('Your provider account is pending approval. You cannot access this module yet.');
