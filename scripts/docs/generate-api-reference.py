...
RESPONSE_OVERRIDES = {
    ...
    ('GET', '/api/v1/admin/disputes'): {'success': True, 'data': [{'id': 'dispute_id', 'caseId': 'DIS-9842', 'customer': {'id': 'customer_id', 'name': 'Eleanor Pena', 'email': 'eleanor.p@gmail.com'}, 'transactionId': 'TRX-78229410', 'orderId': 'order_id', 'orderNumber': 'ORD-88421', 'amount': 492, 'currency': 'PKR', 'priority': 'HIGH', 'status': 'ESCALATED', 'daysOpen': 8, 'reason': 'PRODUCT_NOT_RECEIVED', 'createdAt': '2026-04-01T10:00:00.000Z'}], 'meta': {'page': 1, 'limit': 10, 'total': 1, 'totalPages': 1}, 'message': 'Disputes fetched successfully.'},
    ...
    ('GET', '/api/v1/admin/provider-disputes'): {'success': True, 'data': [{'id': 'provider_dispute_id', 'caseId': 'PRV-101', 'provider': {'id': 'provider_id', 'businessName': 'Acme Corp', 'contactName': 'John Smith', 'tier': 'Gold Partner'}, 'customer': {'id': 'customer_id', 'name': 'Michael Chen'}, 'transaction': {'id': 'transaction_id', 'transactionId': 'TXN-998', 'status': 'VERIFIED'}, 'category': 'NON_DELIVERY', 'amount': 650, 'currency': 'PKR', 'status': 'RULING_PENDING', 'priority': 'HIGH', 'riskAssessment': 'HIGH', 'daysOpen': 5, 'createdAt': '2026-04-05T10:00:00.000Z'}], 'meta': {'page': 1, 'limit': 10, 'total': 1, 'totalPages': 1}, 'message': 'Provider disputes fetched successfully.'},
    ...
    ('GET', '/api/v1/provider/reviews'): {'success': True, 'data': [{'id': 'review_id', 'orderId': 'order_id', 'orderNumber': 'ORD-45678', 'customer': {'id': 'customer_id', 'name': 'Michael Chen', 'avatarUrl': None}, 'rating': 5, 'comment': 'Great packaging and timely delivery.', 'createdAt': '2026-04-08T10:00:00.000Z', 'isNew': True, 'likesCount': 3, 'response': {'id': 'response_id', 'body': 'Thank you for your feedback!', 'createdAt': '2026-04-08T11:00:00.000Z'}}], 'meta': {'page': 1, 'limit': 10, 'total': 1, 'totalPages': 1}, 'message': 'Reviews fetched successfully.'},
    ...
    ('GET', '/api/v1/customer/subscription/invoices'): {'success': True, 'data': [{'id': 'invoice_id', 'stripeInvoiceId': 'in_123', 'amountDue': 4.99, 'amountPaid': 4.99, 'currency': 'USD', 'status': 'PAID', 'invoicePdfUrl': 'https://cdn.yourdomain.com/invoices/invoice.pdf', 'periodStart': '2026-04-01T00:00:00.000Z', 'periodEnd': '2026-05-01T00:00:00.000Z', 'createdAt': '2026-04-01T00:00:00.000Z'}], 'meta': {'page': 1, 'limit': 10, 'total': 1, 'totalPages': 1}, 'message': 'Subscription invoices fetched successfully.'},
    ('GET', '/api/v1/uploads'): {'success': True, 'data': [{'id': 'upload_id', 'ownerId': 'user_id', 'ownerRole': 'REGISTERED_USER', 'targetAccountId': None, 'folder': 'user-avatars', 'fileName': 'avatar.png', 'contentType': 'image/png', 'sizeBytes': 1048576, 'fileUrl': 'https://cdn.yourdomain.com/user-avatars/avatar.png', 'storageKey': 'user-avatars/user_id/uuid-avatar.png', 'status': 'COMPLETED', 'giftId': None, 'createdAt': '2026-04-08T09:00:00.000Z', 'updatedAt': '2026-04-08T09:01:00.000Z', 'completedAt': '2026-04-08T09:01:00.000Z'}], 'meta': {'page': 1, 'limit': 10, 'total': 1, 'totalPages': 1}, 'message': 'Uploads fetched successfully.'},
}
REQUEST_OVERRIDES = {
